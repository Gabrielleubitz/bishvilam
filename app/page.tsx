...
import { Shield, Users, Target, Award, Calendar, Phone, Mail, MapPin, Instagram, MessageCircle } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    ...
    {/* Hero Section */}
<section className="relative py-20 bg-cover bg-center bg-no-repeat" style={getHeroImage() ? {backgroundImage: `url(${getHeroImage()})`} : {backgroundColor: '#111827'}}>
  <div className="absolute inset-0 bg-black/60"></div>
  <div className="section-container text-center relative z-10">
    <h1 className="text-4xl md:text-6xl font-black mb-2 uppercase tracking-wider" 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-brand-green rounded-full mt-2"></div>
                  <span>הכרת משפחות הגיבורים בפרוייקט ״בשבילם״</span>
                </li>
              </ul>
            </div>
  ...
  <div className="flex justify-center lg:justify-start mb-4">
    ...
    />
              ...
              <div className="flex gap-3 justify-center lg:justify-start">
                <a 
                  href="https://www.tiktok.com/@bishvilam" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-800 hover:bg-black rounded-lg flex items-center justify-center transition-colors group"
                  title="TikTok"
                >
                  <svg 
                    width="20" 
                  ...
                  >
                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-.88-.05A6.33 6.33 0 0 0 5.76 20.7a6.33 6.33 0 0 0 10.8-4.4V8.56a8.15 8.15 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.74-.99z"/>
                  </svg>
                </a>
                <a 
